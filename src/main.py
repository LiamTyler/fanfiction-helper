...
for i in range(N):
    ...
    if "slash" in desc and SlashSpecific( desc ) != 2:
        print( "Story", i, ", desc = '", desc, "'" )
"""

"""
desc = "Harry Potter and the Secret Sanctuary, desc = This fic has been renamed, was 'Year of Discovery'. Harry and co.’s 6th year is filled with new powers, places, experiences and faces. HighPower!Harry. No slash. Ships can be found in the AN at the beginning of the first chapter."
desc = desc.lower()
pos = desc.find( "slash" )
if pos == -1:
    print( "pos == -1" )
